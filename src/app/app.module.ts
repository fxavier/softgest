...
import { SubcategoriasPesquisaComponent } from './pages/subcategorias/subcategorias-pesquisa/subcategorias-pesquisa.component';
import { SubcategoriasCadastroComponent } from './pages/subcategorias/subcategorias-cadastro/subcategorias-cadastro.component';
...
@NgModule({
  ...
  declarations: [
    ...
    SubcategoriasPesquisaComponent,
    SubcategoriasCadastroComponent
  ],
  entryComponents: [
    VerticalMenuComponent
  ],
