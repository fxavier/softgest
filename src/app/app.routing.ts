...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'categorias', component: CategoriasPesquisaComponent, data: { breadcrumb: 'Categorias' } },
            { path: 'categorias/nova', component: CategoriasCadastroComponent, data: { breadcrumb: 'Categorias Nova'} },
